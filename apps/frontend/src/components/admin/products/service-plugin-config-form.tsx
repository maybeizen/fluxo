...
export interface ServicePluginConfigFormProps {
    ...
    disabled?: boolean
    overriddenFieldKeys?: Set<string>
}
    ...
    return (
        <div className="space-y-4">
            {configFields.map((field) => {
                const overridden = overriddenFieldKeys.has(field.key)
                const fieldDisabled = disabled || overridden
