...
import { type User, UserRole } from '@fluxo/types'
...
export default function UserTable({
    ...
    const formatDate = (date: Date | string) => (
        <FormattedDate date={date} variant="full" />
    )
                    ...
                    {users.map((user, index) => (
                        ...
                        >
                            <td className="px-4 py-3">
                                <CopyIdCell id={user.uuid} label="User ID" />
                            </td>
                            <td className="px-4 py-3">
                                    ...
                                    {onDelete &&
                                        currentUserRole === UserRole.ADMIN && (
                                            <Button
                                                ...
                                                className="px-3"
                                                aria-label={`Delete user ${user.profile?.username ?? user.uuid}`}
                                            >
                                                <i
