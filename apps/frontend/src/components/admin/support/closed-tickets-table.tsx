...
import { type Ticket, TicketType, type UserProfile } from '@fluxo/types'
...
interface ClosedTicketsTableProps {
    tickets: Ticket[]
}

export default function ClosedTicketsTable({
    tickets,
}: ClosedTicketsTableProps) {
        ...
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center">
                <div className="mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-zinc-900">
                    <i className="fas fa-check-circle text-2xl text-zinc-600"></i>
                </div>
