...
import ConfigurableOptionsSection from '@/components/client/store/configurable-options-section'
...
export default function StorePage() {
    ...
    const [configurableSelections, setConfigurableSelections] = useState<
            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="space-y-6">
                    ...
                    >
                        {selectedProduct && (
                            <div className="mb-6">
                                <ConfigurableOptionsSection
                                    productId={Number(selectedProduct.uuid)}
                                    selections={configurableSelections}
                                    onChange={setConfigurableSelections}
                                />
                            </div>
                        )}
                        <ServiceConfig
                    ...
                    {canViewSummary && selectedProduct && (
                        <Card padding="lg">
                            <OrderSummary
                                ...
                                version={version}
                                productId={Number(selectedProduct.uuid)}
                                configurableSelections={configurableSelections}
                            />
                        </Card>
                    )}
                </div>
