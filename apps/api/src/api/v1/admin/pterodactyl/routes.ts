...
router.get('/', requireAdminOnly, getPterodactylSettings)
router.patch('/', requireAdminOnly, updatePterodactylSettings)
router.post('/test-credentials', requireAdminOnly, testPterodactylCredentials)
